...
**What counts as a warning, and what deliberately doesn't.** `CLEAN` tracks exactly seven signals, all *verified* (code-derived from real tool output or the fault catalog's own declared expectations), not self-reported:
