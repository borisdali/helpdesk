...
Before diving into aiHelpDesk we recommend reviewing our [design principles](PRINCIPLES.md) and the [FAQ](FAQ.md) that may address some of the questions about the product.
