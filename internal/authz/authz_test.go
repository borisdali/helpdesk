...
var gatewayRoutes = []string{
	...
	"GET /api/v1/fleet/playbook-runs",
	...
	"POST /api/v1/fleet/playbook-runs/{runID}/request-feedback",
	"GET /api/v1/fleet/playbook-runs/{runID}/evaluation",
	"POST /api/v1/fleet/playbook-runs/{runID}/evaluation",
	"GET /api/v1/fleet/series/{seriesID}/version-stats",
	"GET /api/v1/fleet/calibration",
	"GET /api/v1/fleet/fault-run-history",
