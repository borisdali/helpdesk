...
func main() {
	...
	if auditEnabled {
		...
		delegateTool, guard, err := audit.DelegateTool(auditor, os.Getenv("HELPDESK_AUDIT_URL"), os.Getenv("HELPDESK_AUDIT_API_KEY"), agentRegistry, sessionID, userID, "helpdesk_orchestrator", sessionPurpose)
		if err != nil {
