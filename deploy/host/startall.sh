...
HELPDESK_AUDIT_ENABLED="$AUDIT_ENABLED" HELPDESK_AUDIT_URL="$AUDIT_URL" HELPDESK_POLICY_ENABLED="$POLICY_ENABLED" HELPDESK_INFRA_CONFIG="${HELPDESK_INFRA_CONFIG:-}" start_bg database-agent "$SCRIPT_DIR/database-agent"
HELPDESK_AUDIT_ENABLED="$AUDIT_ENABLED" HELPDESK_AUDIT_URL="$AUDIT_URL" HELPDESK_POLICY_ENABLED="$POLICY_ENABLED" HELPDESK_INFRA_CONFIG="${HELPDESK_INFRA_CONFIG:-}" start_bg k8s-agent      "$SCRIPT_DIR/k8s-agent"
